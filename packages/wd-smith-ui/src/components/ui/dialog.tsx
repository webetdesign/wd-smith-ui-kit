...
//This component is overridden to pass container to DialogPortal
const DialogContent = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { container?: HTMLElement | null, closeButton?: true | false }
>(({ className, children, container, closeButton = true, ...props }, ref) => (
